...
下面看一下**双精度数是如何保存**的：
![](https://cdn.nlark.com/yuque/0/2020/png/1500604/1603641384908-7958dffa-6d26-4e36-963e-b41c9e3ca8b0.png#height=160&id=GENeZ&originHeight=160&originWidth=720&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=none&title=&width=720)
...
```
其流程图如下：
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615475217180-eabe8060-a66a-425d-ad4c-37c3ca638a68.png#height=426&id=mtLhu&originHeight=426&originWidth=1005&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=1005)
### 12. 其他值到字符串的转换规则？
