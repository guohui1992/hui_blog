...
![浏览器原理面试题.png](https://cdn.nlark.com/yuque/0/2021/png/1500604/1621608379974-5f496e1b-b721-4317-bd17-c3bb0411a510.png#clientId=u9ef7d68e-ce03-4&errorMessage=unknown%20error&from=ui&height=1075&id=u560592e3&originHeight=2454&originWidth=3424&originalType=binary&ratio=1&rotation=0&showTitle=false&size=968517&status=error&style=shadow&taskId=ucededc02-227a-4c57-915a-6e91a940401&title=&width=1500)
## 一、浏览器安全
### 1.  什么是 XSS 攻击？
#### （1）概念
...
**Chrome浏览器的架构图**：
![](https://cdn.nlark.com/yuque/0/2020/png/1500604/1603803289911-191cabf3-e7e2-4354-a83d-858668cc116f.png#height=346&id=iPHYC&originHeight=494&originWidth=1142&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=800)
...
### 3. 浏览器渲染进程的线程有哪些
浏览器的渲染进程的线程总共有五种：
![](https://cdn.nlark.com/yuque/0/2020/png/1500604/1603803289922-6462f252-aa33-4cf6-b541-d8bc2e285125.png#height=428&id=NeQsQ&originHeight=457&originWidth=854&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=800)
**（1）GUI渲染线程**
...
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615478097248-5e3c9a93-5683-41de-8787-e87705d31fe1.png#height=326&id=BwMRa&originHeight=722&originWidth=1770&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=800)
在 Cache 中也可以发现所需的文件已被缓存：
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615477994804-e7eaa2c7-91bf-406d-b024-5add76d37d5e.png#height=521&id=tzZll&originHeight=728&originWidth=1118&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=800)
## 三、浏览器缓存
### 1. 对浏览器的缓存机制的理解
**浏览器缓存的全过程：**
...
![业务流程图1.png](https://cdn.nlark.com/yuque/0/2021/png/1500604/1618399660902-60a33dae-cedc-4bd0-9a5b-160c5da3f516.png#height=528&id=vXaw9&originHeight=657&originWidth=995&originalType=binary&ratio=1&rotation=0&showTitle=false&size=78100&status=done&style=shadow&title=&width=800)
...
 
大致过程如图所示：
![](https://cdn.nlark.com/yuque/0/2020/png/1500604/1603797939165-3bf54e28-5469-4093-a0e1-e0569cec1305.png#height=307&id=MziEN&originHeight=307&originWidth=663&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=663)
...
两者区别如图示：
![](https://cdn.nlark.com/yuque/0/2020/jpeg/1500604/1605256274960-50bd9e69-dde9-4782-b2c0-6afc8188fca2.jpeg#height=660&id=DgpO2&originHeight=660&originWidth=522&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=522)
...
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615476500217-472563e1-de67-403f-baa7-0fd574d0e618.png#height=322&id=LQHPd&originHeight=1274&originWidth=3161&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=800)
Event Loop 执行顺序如下所示：
...
![](https://cdn.nlark.com/yuque/0/2021/gif/1500604/1615476375478-4f0a93a1-de5e-4536-9bbe-4e69c1f91773.gif#height=412&id=h5D8v&originHeight=623&originWidth=1211&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=800)
...
bar()
```
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615476375462-269c6a54-a21d-460c-aa82-a713ef9a2999.png#height=121&id=vFMvg&originHeight=121&originWidth=614&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=614)
...
bar()
```
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615476375388-2867ba62-cf27-4740-91fd-485f0ae12986.png#height=158&id=YIsxC&originHeight=158&originWidth=511&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=511)
### 9. Node 中的 Event Loop 和浏览器中的有什么区别？process.nextTick 执行顺序？
Node 中的 Event Loop 和浏览器中的是完全不相同的东西。

Node 的 Event Loop 分为 6 个阶段，它们会按照**顺序**反复运行。每当进入某一个阶段的时候，都会从对应的回调队列中取出函数去执行。当队列为空或者执行的回调函数数量到达系统设定的阈值，就会进入下一阶段。
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615476641904-a9763034-9114-4a7c-aa50-1bdb612f2f5e.png#height=442&id=Iu20r&originHeight=442&originWidth=745&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=745)
...
![](https://cdn.nlark.com/yuque/0/2021/png/1500604/1615476641927-75409d91-38a1-4797-aa75-cb02dd95d732.png#height=1227&id=anu6V&originHeight=1227&originWidth=644&originalType=binary&ratio=1&rotation=0&showTitle=false&size=0&status=done&style=shadow&title=&width=644)
```javascript
setTimeout(() => {
  console.log('timer21')
}, 0)
