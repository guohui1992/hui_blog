import{_ as s,c as n,o as a,d as l}from"./app.a2c38dd0.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"子配置文件目录","slug":"子配置文件目录","link":"#子配置文件目录","children":[]},{"level":2,"title":"举个例子","slug":"举个例子","link":"#举个例子","children":[{"level":3,"title":"1.启动nginx容器","slug":"_1-启动nginx容器","link":"#_1-启动nginx容器","children":[]},{"level":3,"title":"2.修改配置文件","slug":"_2-修改配置文件","link":"#_2-修改配置文件","children":[]},{"level":3,"title":"3.配置网站文件","slug":"_3-配置网站文件","link":"#_3-配置网站文件","children":[]},{"level":3,"title":"4.重启nginx容器","slug":"_4-重启nginx容器","link":"#_4-重启nginx容器","children":[]},{"level":3,"title":"5.测试","slug":"_5-测试","link":"#_5-测试","children":[]},{"level":3,"title":"6.验证成功！","slug":"_6-验证成功","link":"#_6-验证成功","children":[]}]}],"relativePath":"views/backend/nginx/配置相关/3.子配置目录.md"}'),e={name:"views/backend/nginx/配置相关/3.子配置目录.md"},p=l(`<h2 id="子配置文件目录" tabindex="-1">子配置文件目录 <a class="header-anchor" href="#子配置文件目录" aria-hidden="true">#</a></h2><p>个人自定义的网站配置文件可以放在该目录下，命名为<code>xxx.conf</code></p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">server </span><span style="color:#89DDFF;">{</span></span>
