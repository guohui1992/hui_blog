import{_ as s,c as n,o as a,d as l}from"./app.44407a64.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{"author":"coder-li","tags":"nginx随机主页模块 nginx/modules/random_index_module","aliases":"随机主页"},"headers":[],"relativePath":"views/backend/nginx/基础知识/2.随机主页模块.md"}'),p={name:"views/backend/nginx/基础知识/2.随机主页模块.md"},o=l(`<p>通过设置server块中的主页location配置</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki"><code><span class="line"><span style="color:#676E95;">#lj.conf</span></span>
