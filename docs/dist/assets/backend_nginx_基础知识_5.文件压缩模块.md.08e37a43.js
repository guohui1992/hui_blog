import{_ as s,c as a,o as n,d as p}from"./app.fb76cbe0.js";const y=JSON.parse('{"title":"原理介绍","description":"","frontmatter":{"author":"coder-li","tags":"nginx/modules/ngx_http_gzip_module 内核优化","aliases":null},"headers":[],"relativePath":"backend/nginx/基础知识/5.文件压缩模块.md"}'),l={name:"backend/nginx/基础知识/5.文件压缩模块.md"},e=p(`<h1 id="原理介绍" tabindex="-1">原理介绍 <a class="header-anchor" href="#原理介绍" aria-hidden="true">#</a></h1><p>启动该模块，使文件传输前进行压缩，提升传输效率</p><h1 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-hidden="true">#</a></h1><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki"><code><span class="line"><span style="color:#676E95;"># 默认 gzip off</span></span>
