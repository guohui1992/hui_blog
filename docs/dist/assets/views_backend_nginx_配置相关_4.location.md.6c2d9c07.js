import{_ as s,c as n,o as a,d as l}from"./app.526f2fa0.js";const A=JSON.parse('{"title":"一、语法","description":"","frontmatter":{"author":"coder-li","tags":"nginx-location"},"headers":[],"relativePath":"views/backend/nginx/配置相关/4.location.md"}'),o={name:"views/backend/nginx/配置相关/4.location.md"},p=l(`<div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">http </span><span style="color:#89DDFF;">{</span><span style="color:#A6ACCD;"> </span></span>
