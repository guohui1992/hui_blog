import{_ as s,c as n,o as a,d as p}from"./app.44407a64.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{"author":"coder-li","tags":"nginx/modules/ngx_http_proxy_mudule","aliases":"nginx反向代理"},"headers":[],"relativePath":"views/backend/nginx/配置相关/6.proxy代理.md"}'),l={name:"views/backend/nginx/配置相关/6.proxy代理.md"},o=p(`<div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;"># URL指向的是真正的业务服务器</span></span>
